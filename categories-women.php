                ...
                <div class="brand">
                    <div class="container-fluid">
                        <div class="brand-slider">
                            <div class="brand-item"><img src="img/slider-18.png" alt=""></div>
                            <div class="brand-item"><img src="img/slider-19.jfif" alt=""></div>
                            <div class="brand-item"><img src="img/slider-20.png" alt=""></div>
                            <div class="brand-item"><img src="img/slider-21.png" alt=""></div>
                            <div class="brand-item"><img src="img/slider-22.jfif" alt=""></div>
                            <div class="brand-item"><img src="img/slider-23.jfif" alt=""></div>
                        </div>
                    </div>
                </div>
                <!-- Brand End -->      
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM raffle_products WHERE Category = 'Women' AND UserID != '$userID' AND Stock != 0 AND IsRaffled != 0";
