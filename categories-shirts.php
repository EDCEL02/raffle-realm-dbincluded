                ...
                <div class="brand">
                    <div class="container-fluid">
                        <div class="brand-slider">
                            <div class="brand-item"><img src="img/slider-12.png" alt=""></div>
                            <div class="brand-item"><img src="img/slider-13.png" alt=""></div>
                            <div class="brand-item"><img src="img/slider-14.jfif" alt=""></div>
                            <div class="brand-item"><img src="img/slider-15.jfif" alt=""></div>
                            <div class="brand-item"><img src="img/slider-16.png" alt=""></div>
                            <div class="brand-item"><img src="img/slider-17.png" alt=""></div>
                        </div>
                    </div>
                </div>
                <!-- Brand End -->      
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM raffle_products WHERE Category = 'Shirts' AND UserID != '$userID' AND Stock != 0 AND IsRaffled != 0";
                            ...
                            <div id="purchase-form" class="purchase-form">
                                <div class = "purchase-form-content" id="ticketForm" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; background: #fff; padding: 20px; border: 1px solid #ccc; z-index: 999;">
                                    ...
                                    <form id="ticketPurchaseForm" action="php/upload_tickets.php" method="post" onsubmit="return checkFormSubmission()">
                                        <div class="quantity">
                                            <div class="qty">
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                <li><a href="#">AXGG </a><span>(45)</span></li>
                                <li><a href="#">Levis</a><span>(34)</span></li>
                                <li><a href="#">Lee </a><span>(67)</span></li>
                                <li><a href="#">Petrol</a><span>(74)</span></li>
                                <li><a href="#">Shirts </a><span>(89)</span></li>
                                <li><a href="#">Handsome</a><span>(28)</span></li>
                            </ul>
                        </div>
