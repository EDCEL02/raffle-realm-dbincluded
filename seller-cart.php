                            ...
                            <div class="table-responsive">
                                ...
                                <thead class="thead-dark">
                                    <tr class="text-center">
                                        ...
                                        <th style = background-color:blanchedalmond;>Disable</th>
                                    </tr>
                                </thead>
                                <tbody class="align-middle text-center">
                                <div style="display: flex; justify-content: space-between; width: 100%;">
                                    <h1>RAFFLED PRODUCTS</h1>
                                    <button class="btn-cart" style="border-radius: 10px; margin-bottom: 20px; padding: 0 20px; background-color:#20e282;" onclick="redirect()">
                                        <?php echo $isRaffledStatus == 1 ? 'Active Raffles' : 'Inactive'; ?>
                                    </button>
                                ...
                                function redirect() {
                                    ...
                                    window.location.href = 'seller-cart2.php';
                                }
                                </script>
                                ...
                                $isRaffled = $isRaffledStatus == 1;

                                // Update the SQL query based on the value of $isRaffled
                                $sql = "SELECT * FROM raffle_products WHERE UserID = $userID AND IsRaffled = $isRaffled";
                                ...
                                $result = $conn->query($sql);
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<form id="banForm-' . $productId . '" action="php/disable_sold_product.php" method="post">';
                                            echo '<td><button type="button" class="ban-btn" onclick="confirmBan(' . $productId . ')"><i class="fa fa-ban"></i></button></td>';
                                    ...
                                    <script>
                                        function confirmBan(productId) {
                                            // Display a confirmation dialog
                                            var confirmation = window.confirm("Are you sure you want to disable this product?");
